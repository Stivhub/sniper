...
client.on("messageCreate", (message) => {
							...
							embeds: [
								new MessageEmbed()
									...
									.addFields({
										...
										value:
											"<:1ac_symboldot:919542129699721236> " +
	...
	if (message.content.toLowerCase() === "-editsnipe") {
				...
				snipe
					? {
							embeds: [
								new MessageEmbed()
									.setDescription(
										"<:ac_sussyeyes:933418179311570965> Edited **[this message](" +
											snipe.link +
											")** <:ac_sussyeyes:933418179311570965>"
									)
									.addFields(
										{
											name: "Old Message:",
	...
	if (message.content.toLowerCase() === "-imagesnipe") {
		const snipe = imageSnipes[message.channel.id];
		var imgcontent;
		if (snipe != undefined) {
			if (snipe.content == "") {
				imgcontent =
					"<:replycont:895591087945711638>Deleted an image ";
			} else {
				imgcontent =
...
client.login('OTMzNDEzMzEzOTI3MzM1OTM3.YehK5A.z9Cupsdn2qI87oP0_UI0B87VOTA');